...
class AgentRegistry {
   ...
   * @param {string} configuration.name - Agent name
   * @param {Array} configuration.capabilities - Agent capabilities
   * @param {Object} configuration.metadata - Additional metadata
