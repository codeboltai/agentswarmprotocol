...
var AgentManager = /** @class */ (function (_super) {
     ...
     */
    function AgentManager(sendRequest) {
        ...
        return __awaiter(this, arguments, void 0, function (filters) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.content.agents];
                }
            });
        });
    };
     ...
     */
    AgentManager.prototype.registerEventListeners = function (emitter) {
        var _this = this;
        emitter.on('agent-list', function (agents) {
            _this.emit('agent-list', agents);
        });
    };
    return AgentManager;
